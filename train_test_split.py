...
trg = './yolov7/datasets/CHV_dataset/{folder}/images/'
trg_a = './yolov7/datasets/CHV_dataset/{folder}/labels/'
...
for fname in train_imgs:
    ...
    shutil.copy2(os.path.join('./orig_datasets/',fname), trg.format(folder='train'))
...
for fname in val_imgs:
    ...
    print('------')
    print(annotation_name)
    shutil.copy2(os.path.join('./orig_datasets/',fname), trg.format(folder='val'))
    shutil.copy2(os.path.join(src_a,annotation_name+'.txt'), trg_a.format(folder='val'))
...
for fname in test_imgs:
    ...
    print('------')
    print(annotation_name)
    shutil.copy2(os.path.join('./orig_datasets/',fname), trg.format(folder='test'))
