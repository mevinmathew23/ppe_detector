...
# paths
src = './CHV_dataset/images/'
src_a = './CHV_dataset/annotations/'
...
f_train = open('./CHV_dataset/data_split/train.txt')
train_imgs = f_train.read().splitlines()
f_train.close()

f_val = open('./CHV_dataset/data_split/valid.txt')
val_imgs = f_val.read().splitlines()
f_val.close()

f_test = open('./CHV_dataset/data_split/test.txt')
